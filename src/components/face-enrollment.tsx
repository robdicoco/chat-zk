  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Facial Enrollment</CardTitle>
          <CardDescription>Set up your facial biometrics for secure payment authorization</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {isLoading ? (
            ...
            <Alert className="bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-900">
              ...
              <AlertDescription>
                Your facial biometrics have been securely enrolled. You can now use the chat payment system.
              </AlertDescription>
            </Alert>
          ) : (
            <>
